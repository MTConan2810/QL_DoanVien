...
namespace QL_DoanVien
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="QLDoanVien")]
    ...
    partial void DeletePhanQuyen(PhanQuyen instance);
		...
		public QLDVDataContext() : 
				base(global::QL_DoanVien.Properties.Settings.Default.QLDoanVienConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnDoanPhiChanging(byte value);
    ...
    partial void OnMaKHChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DoanPhi", DbType="TinyInt NOT NULL")]
		public byte DoanPhi
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="KhoaHoc_Student", Storage="_KhoaHoc", ThisKey="MaKH", OtherKey="MaKH", IsForeignKey=true)]
    ...
    partial void OnLastCodeChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="KhoaHoc_Student", Storage="_Students", ThisKey="MaKH", OtherKey="MaKH")]
		public EntitySet<Student> Students
		{
			get
			{
    ...
    partial void OnMaRoleChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Role_User", Storage="_Role", ThisKey="MaRole", OtherKey="MaRole", IsForeignKey=true)]
		public Role Role
		{
			get
			{
    ...
    partial void OnTenRoleChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Role_User", Storage="_Users", ThisKey="MaRole", OtherKey="MaRole")]
		public EntitySet<User> Users
		{
			get
			{
